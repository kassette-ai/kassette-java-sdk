 ...
 *
 * @see <a href="https://kassette.ai/docs/spec/page/">Page</a>
 */
@AutoValue
@AutoGson //
public abstract class ReportingMessage implements Message {
    ...
    /** Fluent API for creating {@link ReportingMessage} instances. */
    public static class Builder extends MessageBuilder<ReportingMessage, Builder> {
        private String name;
        private Map<String, ?> properties;
        private String category;

        private Builder(ReportingMessage page) {
            super(page);
            name = page.name();
         ...
         *
         * @see <a href="https://kassette.ai/docs/spec/page/#properties">Properties</a>
         */
        ...
        @Override
        protected ReportingMessage realBuild(
                Type type,
                String messageId,
                Date sentAt,
                String channel,
            ...
            return new AutoValue_ReportingMessage(
                    type,
                    messageId,
                    sentAt,
                    timestamp,
